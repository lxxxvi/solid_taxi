...
class SolidTaxi::SolidQueue::JobTest < ActiveSupport::TestCase
  test "CUSTOM__STATUS_CASE_WHEN_BLOCK" do
    expectation = <<~SQL
      CASE
    ...
    assert_equal(
      expectation,
      SolidTaxi::SolidQueue::Job::CUSTOM__STATUS_CASE_WHEN_BLOCK
    )
  end
end
